...
public class nometales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setFont(new java.awt.Font("Footlight MT Light", 1, 24)); // NOI18N
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 560, 190));
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        // TODO add your handling code here:
         jTextArea1.setText("Los no metales son elementos químicos que\n"
                 + " no son buenos conductores de la\n"
                 + " corriente eléctrica y el calor. Son muy débiles,\n"
                    + " por lo que no se pueden ni estirar ni convertir \n"
                 + "en una lámina");
